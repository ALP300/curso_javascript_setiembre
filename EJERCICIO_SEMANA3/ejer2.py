...
Al final debe mostrar también el número total 
de créditos del curso.
'''
curso= {'Tesis': 4, 'Algoritmo': 5, 'Calculo': 4, 'BD':3}
total_creditos=0
for asignatura, creditos in curso.items():
    print(asignatura, 'tiene ', creditos)
    total_creditos+=creditos
print("Número de créditos totales: ", total_creditos)